                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                               ...
                               <!-- <li><a title="Business List" href="business-list.php"><span class="mini-sub-pro">Business users</span></a></li>-->
                                ...
                                <li><a title="car Category" href="addcategory.php"><span class="mini-sub-pro">Add New Car</span></a></li>
                               <li><a title="Other Items" href="other-items.php"><span class="mini-sub-pro">Other items</span></a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
