                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li><a title="Other Items" href="other-items.php"><span class="mini-sub-pro">user items</span></a></li> 
                                    ...
                                    <form class="modal-content" action="#" method="post">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="car details">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">Car type</label>
                                                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="cartype">
                                            </div>

                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                            <input type="submit" class="btn btn-primary" name="updateSubmit" value="Save changes">
                                        </div>
                                    </form>
                                </div>
                            </div>
