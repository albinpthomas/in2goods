                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li><a href="#INFORMATION"><i class="icon nalika-chat" ></i> Add Cars</a></li>
                                </ul>
                                                    ...
                                                    <div class="card-block">
                                                        <form action="#" method="post">
                                                            <div class="input-group mg-b-15 mg-t-15">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="Car Detail" name="carDetails">
                                                            </div>
                                                            ...
                                                            <div class="input-group mg-b-15">
                                                                <select class='form-control ' name="company_i">
                                                                    <?php
                                                                    $fetchComp = "SELECT * from car_company";
                                                                    $fetchRes = mysqli_query($connect, $fetchComp);
                                                                    while ($rowF = mysqli_fetch_array($fetchRes)) {
                                                                        echo "<option value='".$rowF['company_id']."'>".$rowF['company_name']."</option>";
                                                                    }
                                                                    ?>
                                                                    </select>
                                                            </div>

                                                            <div class="form-group review-pro-edt mt-5 mg-b-0-pt" style="margin-top: 20px;">
                                                                <button type="submit" name="AddNewCate" class="btn btn-ctl-bt waves-effect waves-light">Submit
                                                                </button>
                                                            </div>
                                                        </form>
                                                    </div>
...
if(isset($_POST['AddNewCate']))
{
    ...
    $sql="INSERT INTO `car_category`( `car_details`, `car_type`, `company_id`) VALUES ('$carDetails','$carType','$company_i')";
